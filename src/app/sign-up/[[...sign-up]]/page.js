...
export default function SignUpPage() {
  ...
  const signInWith = async (strategy) => {
    ...
    try {
      ...
      // In many Clerk versions, 'authenticateWithPopup' is a shortcut,

      // but passing flow: 'popup' to the redirect method is the stable internal path.
      ...
      await signIn.authenticateWithRedirect({
        ...
        flow: 'popup' // This explicitly tells Clerk to open a window instead of redirecting

      });

    } catch (err) {

      console.error("Popup interaction failed, falling back to redirect:", err);

     

      // Fallback to standard redirect if the popup is blocked by the browser
      ...
      <div className="w-full max-w-[440px] z-10">
        ...
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 mt-2 font-medium italic">Master German through Levels</p>
