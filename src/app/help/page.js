            ...
            <div key={i} className="group bg-[#0a0a0a] border border-white/5 p-8 rounded-[2.5rem] hover:border-orange-500/30 transition-all">
              ...
              <ul className="space-y-4">
                {cat.links.map((link, j) => (
                  <li key={j}>
                    <button className="flex items-center justify-between w-full text-white/40 hover:text-white font-bold uppercase text-xs tracking-widest group/link transition-colors">
                      {link}
