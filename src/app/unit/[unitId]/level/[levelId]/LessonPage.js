        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
                ...
                /** * FIX: Prepend "1-" to the ID.

                 * Backend expects: Section-Unit-Level (e.g., 1-1-3)

                 * We are using SECTION_1_DATA, so section is hardcoded to 1.
                ...
                // Use router or window for redirect
