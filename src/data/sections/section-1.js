...
export const SECTION_1_DATA = [
     ...
     [
  {
    ...
    "questions": [
      ...
      { "type": "jumble", "q": "The water is cold", "options": ["kalt", "das", "ist", "Wasser"], "a": "das Wasser ist kalt" },
      ...
      { "type": "jumble", "q": "The milk is hot", "options": ["ist", "die", "heiß", "Milch"], "a": "die Milch ist heiß" },
      { "type": "jumble", "q": "The milk and the coffee", "options": ["Kaffee", "die", "und", "der", "Milch"], "a": "die Milch und der Kaffee" },

      // --- CONCEPT 5: NEGATION ---
      { "type": "intro", "word": "nicht", "translation": "not", "content": "To say 'is not', use 'ist nicht'." },
      { "type": "jumble", "q": "The coffee is not cold", "options": ["nicht", "Kaffee", "der", "kalt", "ist"], "a": "der Kaffee ist nicht kalt" },
      { "type": "jumble", "q": "The milk is not hot", "options": ["die", "ist", "heiß", "nicht", "Milch"], "a": "die Milch ist nicht heiß" },
      ...
      { "type": "jumble", "q": "Is the water cold?", "options": ["das", "Wasser", "kalt", "Ist"], "a": "Ist das Wasser kalt" },
      { "type": "jumble", "q": "Is the milk hot?", "options": ["Milch", "Ist", "die", "heiß"], "a": "Ist die Milch heiß" },
  ...
  // src/data/section-1.js (Unit 1, Level 2)
  {
    ...
    "questions": [
      ...
      { "type": "jumble", "q": "I would like coffee", "options": ["möchte", "Ich", "Kaffee"], "a": "Ich möchte coffee" },
      ...
      { "type": "jumble", "q": "I would like the coffee", "options": ["Kaffee", "den", "möchte", "Ich"], "a": "Ich möchte den Kaffee" },
      ...
      { "type": "jumble", "q": "I would like the water", "options": ["möchte", "Wasser", "das", "Ich"], "a": "Ich möchte das Wasser" },
      { "type": "jumble", "q": "I would like the milk", "options": ["die", "möchte", "Milch", "Ich"], "a": "Ich möchte die Milch" },
      ...
      { "type": "jumble", "q": "I would like the milk, please", "options": ["Ich", "Milch", "die", "bitte", "möchte"], "a": "Ich möchte die Milch bitte" },
      { "type": "jumble", "q": "The tea, please", "options": ["Tee", "bitte", "der"], "a": "der Tee bitte" },
      { "type": "choice", "q": "Which word means 'please'?", "options": ["danke", "bitte", "und"], "a": "bitte" },

      // --- CONCEPT 6: COMBINING EVERYTHING ---
      { "type": "jumble", "q": "I would like the water and the coffee", "options": ["das", "und", "den", "Kaffee", "Wasser", "möchte", "Ich"], "a": "Ich möchte das Wasser und den Kaffee" },
      { "type": "jumble", "q": "I would like the milk, thanks", "options": ["danke", "die", "Milch", "Ich", "möchte"], "a": "Ich möchte die Milch danke" },
      ...
      { "type": "jumble", "q": "I would like the tea, please", "options": ["den", "bitte", "Tee", "möchte", "Ich"], "a": "Ich möchte den Tee bitte" },
      ...
      { "type": "jumble", "q": "Final Jumble: I would like the tea, the milk, and the water", "options": ["die", "den", "und", "Tee", "Wasser", "das", "Milch", "möchte", "Ich"], "a": "Ich möchte den Tee die Milch und das Wasser" },
  ...
  // src/data/section-1.js (Unit 1, Level 3)
  {
    ...
    "questions": [
      ...
      { "type": "jumble", "q": "Good day, the coffee please", "options": ["Tag", "der", "bitte", "Kaffee", "Guten"], "a": "Guten Tag der Kaffee bitte" },
      ...
      { "type": "jumble", "q": "Excuse me, the water please", "options": ["bitte", "Entschuldigung", "Wasser", "das"], "a": "Entschuldigung das Wasser bitte" },
      ...
      { "type": "jumble", "q": "You have the coffee", "options": ["den", "Sie", "Kaffee", "haben"], "a": "Sie haben den Kaffee" },
      ...
      { "type": "jumble", "q": "Do you have tea?", "options": ["Sie", "Tee", "Haben"], "a": "Haben Sie Tee" },
      { "type": "jumble", "q": "Excuse me, do you have milk?", "options": ["Haben", "Milch", "Entschuldigung", "Sie"], "a": "Entschuldigung Haben Sie milk" },
      ...
      { "type": "jumble", "q": "The milk is very delicious", "options": ["lecker", "die", "sehr", "ist", "Milch"], "a": "die Milch ist sehr lecker" },
      ...
      { "type": "jumble", "q": "Do you have the water and the tea?", "options": ["und", "Sie", "Tee", "den", "Haben", "Wasser", "das"], "a": "Haben Sie das Wasser und den Tee" },
      { "type": "choice", "q": "What is 'The tea' when it's an object?", "options": ["der Tee", "den Tee", "das Tee"], "a": "den Tee" },
      { "type": "jumble", "q": "Good day, I would like the coffee", "options": ["Tag", "den", "Ich", "Guten", "möchte", "Kaffee"], "a": "Guten Tag Ich möchte den Kaffee" },
      ...
      { "type": "jumble", "q": "Final Jumble: Excuse me, do you have the coffee please", "options": ["Sie", "den", "bitte", "Entschuldigung", "Kaffee", "Haben"], "a": "Entschuldigung Haben Sie den Kaffee bitte" },
  ...
  // src/data/section-1.js (Unit 1, Level 4)
  {
    ...
    "questions": [
      ...
      { "type": "jumble", "q": "The cake is delicious", "options": ["Kuchen", "lecker", "ist", "der"], "a": "der Kuchen ist lecker" },
      ...
      { "type": "jumble", "q": "The bread is hot", "options": ["Brot", "heiß", "ist", "das"], "a": "das Brot ist heiß" },

      // --- CONCEPT 3: ORDERING FOOD (ACCUSATIVE) ---
      { "type": "jumble", "q": "I would like the cake", "options": ["Kuchen", "den", "Ich", "möchte"], "a": "Ich möchte den Kuchen" },
      { "type": "choice", "q": "Why did we use 'den' for cake?", "options": ["It is an object", "It is feminine", "It is plural"], "a": "It is an object" },
      { "type": "jumble", "q": "I would like the bread", "options": ["Brot", "möchte", "Ich", "das"], "a": "Ich möchte das Brot" },
      ...
      { "type": "jumble", "q": "The sandwich is very cold", "options": ["kalt", "ist", "sehr", "Sandwich", "das"], "a": "das Sandwich ist sehr kalt" },
      ...
      { "type": "jumble", "q": "I have hunger (I am hungry)", "options": ["Ich", "habe", "Hunger"], "a": "Ich habe Hunger" },
      ...
      { "type": "jumble", "q": "The cake and the coffee", "options": ["Kaffee", "der", "Kuchen", "der", "und"], "a": "der Kuchen und der Kaffee" },
      { "type": "jumble", "q": "I would like the sandwich and the water", "options": ["Sandwich", "das", "Wasser", "Ich", "und", "möchte", "das"], "a": "Ich möchte das Sandwich und das Wasser" },
      { "type": "choice", "q": "Recall: What is 'The Milk'?", "options": ["der Milch", "die Milch", "das Milch"], "a": "die Milch" },

      // --- CONCEPT 7: QUESTIONS ABOUT FOOD ---
      { "type": "jumble", "q": "Do you have cake?", "options": ["Haben", "Kuchen", "Sie"], "a": "Haben Sie Kuchen" },
      { "type": "jumble", "q": "Is the bread delicious?", "options": ["das", "Brot", "lecker", "Ist"], "a": "Ist das Brot lecker" },

      // --- MIXED REINFORCEMENT ---
      { "type": "jumble", "q": "Excuse me, I would like the cake please", "options": ["möchte", "Kuchen", "bitte", "den", "Entschuldigung", "Ich"], "a": "Entschuldigung Ich möchte den Kuchen bitte" },
      { "type": "choice", "q": "Translate: 'sehr lecker'", "options": ["very hot", "very cold", "very delicious"], "a": "very delicious" },
      ...
      { "type": "jumble", "q": "Final Jumble: The bread is very delicious and the coffee is hot", "options": ["ist", "Brot", "lecker", "und", "der", "Kaffee", "heiß", "das", "sehr", "ist"], "a": "das Brot ist sehr lecker und der Kaffee ist heiß" },
  ...
  // src/data/section-1.js (Unit 1, Level 5)
  {
    ...
    "questions": [
      ...
      { "type": "jumble", "q": "Is the table free?", "options": ["Ist", "Tisch", "frei", "der"], "a": "Ist der Tisch frei" },
      { "type": "jumble", "q": "The table is free and I would like coffee", "options": ["Ich", "Kaffee", "und", "der", "frei", "Tisch", "ist", "möchte"], "a": "der Tisch ist frei und Ich möchte Kaffee" },

      // --- CONCEPT 2: THE MENU ---
      { "type": "intro", "word": "die Karte", "translation": "The Menu", "content": "Ask for 'die Karte' to see the food and drink options." },
      { "type": "jumble", "q": "Excuse me, do you have the menu?", "options": ["die", "Haben", "Karte", "Sie", "Entschuldigung"], "a": "Entschuldigung Haben Sie die Karte" },
      { "type": "jumble", "q": "I would like the menu and the water", "options": ["das", "und", "Ich", "die", "Wasser", "möchte", "Karte"], "a": "Ich möchte die Karte und das Wasser" },

      // --- CONCEPT 3: THE BILL ---
      { "type": "intro", "word": "die Rechnung", "translation": "The Bill", "content": "When you are finished eating and drinking, ask for 'die Rechnung'." },
      { "type": "jumble", "q": "The cake is delicious, the bill please", "options": ["Kuchen", "lecker", "der", "die", "Rechnung", "ist", "bitte"], "a": "der Kuchen ist lecker die Rechnung bitte" },
      ...
      { "type": "jumble", "q": "I would like to pay the bill", "options": ["zahlen", "die", "Ich", "Rechnung", "möchte"], "a": "Ich möchte die Rechnung zahlen" },
      { "type": "jumble", "q": "Good day, I would like to pay", "options": ["zahlen", "Ich", "Tag", "Guten", "möchte"], "a": "Guten Tag Ich möchte zahlen" },
      ...
      { "type": "jumble", "q": "Together please, and the coffee is delicious", "options": ["lecker", "der", "Kaffee", "und", "ist", "zusammen", "bitte"], "a": "zusammen bitte und der Kaffee ist lecker" },
      { "type": "choice", "q": "What do you say if you pay ONLY for your sandwich?", "options": ["zusammen", "getrennt"], "a": "getrennt" },
      { "type": "jumble", "q": "Separately please, thank you", "options": ["getrennt", "danke", "bitte"], "a": "getrennt bitte danke" },

      // --- CONCEPT 6: FULL SCENARIOS ---
      { "type": "jumble", "q": "Do you have a table and the menu please?", "options": ["Tisch", "Haben", "Karte", "bitte", "die", "Sie", "und", "einen"], "a": "Haben Sie einen Tisch und die Karte bitte" },
      { "type": "jumble", "q": "The milk is hot and the tea is very delicious", "options": ["Milch", "der", "und", "sehr", "lecker", "heiß", "die", "ist", "ist", "Tee"], "a": "die Milch ist heiß und der Tee ist sehr lecker" },
      { "type": "jumble", "q": "I would like the bread and the water please", "options": ["Brot", "Wasser", "bitte", "das", "möchte", "und", "Ich", "das"], "a": "Ich möchte das Brot und das Wasser bitte" },
      ...
      { "type": "jumble", "q": "Final Order: I would like the coffee, the cake, and the bill please", "options": ["Rechnung", "den", "möchte", "bitte", "die", "Kuchen", "den", "und", "Kaffee", "Ich"], "a": "Ich möchte den Kaffee den Kuchen und die Rechnung bitte" },
